...
def check_direction(maze_index_value, maze_next_value, direction, end_value, correct_fake_connection):    
    if maze_index_value: #there is a number here
        if maze_index_value + 1 == maze_next_value or maze_index_value - 1 == maze_next_value: 
            maze_character = " "
        elif (maze_index_value, maze_next_value) in correct_fake_connection or (maze_next_value, maze_index_value) in correct_fake_connection:
            maze_character = " "
        else:
...
def evaluate_directions_and_assign(row_position, column_position, maze_index, maze_final, end_value, correct_fake_connection):
    ...
    if column_position <= len(maze_index[0]) - 2: # all columns except for last column
        ...
        maze_final[row_position * 2][(column_position * 2) + 1] = check_direction(maze_value, maze_next_value, 'right', end_value, correct_fake_connection)
